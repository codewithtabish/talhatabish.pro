...
export default function CardFlip({
  ...
  return (
    <div
      className="group relative h-[420px] w-full max-w-[320px] [perspective:2000px]"
    ...
    >
      ...
      >
        ...
        >
          ...
          <div className='absolute bottom-3  p-3 max-w-[100%] left-5 mx-auto flex justify-center '>
              ...
              className={cn(
                ...
                'dark:from-zinc-800 dark:via-zinc-600 dark:to-zinc-600',
            ...
            >
              <span className="group-hover/start:text-primary w-full text-center text-sm font-semibold text-zinc-900 dark:text-white">
                {title}
              </span>
        ...
        >
          ...
          <div className="relative z-10 flex-1 space-y-5">
            <div className="space-y-2">
              ...
              <p className="line-clamp-3 text-sm tracking-tight text-zinc-600 dark:text-zinc-400">
                {subtitle}
              </p>
            </div>
